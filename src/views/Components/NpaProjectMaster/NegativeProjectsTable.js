...
//*Components
import AddNegativeProjects from "./AddNegativeProjects";
...
const EnhancedTableToolbar = (props) => {
  const { numSelected, pageno, pageSize, selected,npa_project_master } = props;
    ...
    >
      ...
      {numSelected > 0 ? (
        <div className="d-flex">
          ...
          {npa_project_master.delete_status=="1"?(
          <DeleteNegativeProjects data={{ selected, pageno, pageSize }} />
          ):("")}
          </div>
          ) : (
            <div className="d-flex">
            {npa_project_master.create_status=="1"?(
  ...
  const columns2 = [
    ...
    renderCell: (params) => {
      return <div className="d-flex">
        {npa_project_master.update_status=="1"?(
  ...
  return (
    <Box sx={{ width: "100%" }}>
      <EnhancedTableToolbar
        ...
        npa_project_master={npa_project_master}
      />
