...
import { searchLearningsData } from "../../../Redux/Creators/LearningsCreators";
...
function Learnings(props) {
  ...
  const handleSearch = () => {
    ...
    props.searchLearningsData(data);
  };
    ...
    <div className="container-fluid">
      ...
      <Card className="p-1 px-2">
        <CardHeader className="shadow-sm border-dark p-0 pb-1 bg-gradient-yellow">
          <Row>
            <Col md={6}>
            <strong className="d-flex flex-column justify-content-center text-center align-items-center h-100">Learnings</strong>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    searchLearningsData: (data) => dispatch(searchLearningsData(data)),
  };
};
