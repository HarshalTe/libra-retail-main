...
//*Actions
import { postMailTimeMaster } from "../../../Redux/Creators/MailTimeCreators";

function CreateMailTime(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.postMailTimeMaster(data, token);
    setSubmitting(true);
    setModal(false);
  };
  ...
  return (
    <div>
      <Tooltip title="Create Mail Time" placement="top">
        <Button
          variant="outlined"
          color="success"
          size="small"
      ...
      >
        <ModalHeader toggle={() => setModal(!modal)}>
          <Typography>
            <strong>Create Mail Time</strong>
          </Typography>
        </ModalHeader>
        <Divider />
...
const mapDispatchToProps = (dispatch) => {
  return {
    postMailTimeMaster: (data, token) =>
      dispatch(postMailTimeMaster(data, token)),
  };
};
