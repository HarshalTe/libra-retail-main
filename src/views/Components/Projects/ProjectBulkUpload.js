...
function ProjectBulkUpload(props) {
...
const [file, setFile] = useState([]);
  ...
  const postDocumentProject = (data, users) => {
    ...
    return axios
      .post("/project-upload", data, config)
      .then((users) => {
        console.log(users);
        ...
        <ModalBody>
          ...
          >
            {(formProps) => (
               ...
               <Col md={6}>
               <a href="https://lvpl.in/librabackend/storage/app/public/Demo/projects.xlsx">
               <Button
          variant="outlined"
          color="info"
          // background="info"
...
export default connect(mapStateToProps, mapDispatchToProps)(ProjectBulkUpload);
