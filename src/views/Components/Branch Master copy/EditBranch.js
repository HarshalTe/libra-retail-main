...
//*Actions
import { editBranchMaster } from "../../../Redux/Creators/CompanyDocumentCreators";
...
console.log("props1121",props)
  ...
  return (
    <div>
      <Tooltip title="Edit Branch" placement="right" className="m-2" style={{float:"right"}}>
      <Button
          variant="outlined"
          color="warning"
          size="small"
              ...
              <Form enctype="multipart/form-data">
                ...
                <Label>Company Detail</Label>
                    ...
                    {props.companies?.companies?.data?.map((user , id)=>{
                       return(
                      <MenuItem value={user}>{user.company_detail}</MenuItem>
                      )
                    })}
                  </TextField>
                  </Col>
