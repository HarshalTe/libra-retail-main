          ...
          {(formProps) => {
            return (
              <Form>
                ...
                <div>
                  {/* <div id="htmlToPdf3" className={print ? "f-10" : "f-14"}> */}
                  <div id="htmlToPdf3" style={{"color":"black"}} className={print ? "f-10 font-family" : "f-14 font-family"}>
                    <div className="logo">
                      <img
                        src={Logo}
                        alt="Logo"
                    ...
                    <div className=" 1-page text-center pdf-h-w">
                      ...
                      <div className="test d-flex">
                        <div className="w-100 p-1 test-r m-0 font-bold">Boundaries</div>
                      </div>
                      ...
                      <div className="test d-flex">
                        <div className="w-100 p-1 test-r m-0 font-bold">Valuation</div>
                      </div>
                      ...
                      <div className="test d-flex">
                        <div className="w-100 text-left p-1 pl-2 test-r">
                          ...
                          <br/>
                          1. The property under consideration is a Ground + 1 Floor storied residential building without lift. The
Ground Floor comprises of 1-1 BHK unit AND the 1st Floor comprises of 3 Individual rooms with a
common Toilet.
<br/>
2. As per site observation access to the building is via Kutcha road and the width is 12 feet approx.
<br/>
3. We have received only Index II copy Sale Deed and Zoning Certificate available for verification.
<br/>
4. Kindly check the Sanctioned plan Commencement Certificate and Occupation Certificate at your end
before disbursement.
<br/>
5. At the time of visit we have observed that property is Partly Self Occupied and partly Tenant Occupied
since last 2 years.
<br/>
6. During our visit we have not observed unit name board.
<br/>
7. Agreement for sale made between Shree Maruti Vishnu Nadhe AND Shree Nurulhuda Adilahmad Khan
on dated 15/07/2011 are made available for verification (Index no: 7701/2011).
<br/>
8. As per Index II and Sale deed 650 sft is identified as the plot area for subject property and the same is
considered for Valuation. There is a ground + 1 Floor Structure on the subject plot. No documents for
Structure are provided. As per site measurements the structure area is approx 1300 sft. This translates to a
FSI of 2 which is high as per market norms. Hence considering 1.5 FSI we have considered the structure
area of 975 sft for Valuation.
<br/>
9. Subject property is a part of larger layout of Survey No 118. Plot numbers are not designated on sites.
We had asked for a copy of Survey Plan/ Layout plans. However the same is not provided. In absence of
the same the subject property is identified Partly on the basis of 4 Boundary page provided( North Side
Kutcha Road). Hence please check for the same.
<br/>
10. Subject Building Comprises of 1- 1 BHK unit on Ground Floor which is Self Occupied. Further the 1st
floor comprises of 3 Individual rooms which are leased out. The terrace comprises of 1 Room with AC
Sheet roof which is also leased out. There are 4 tenants (Ahmad / Ali / Siraj / Musalim / Fias). We have
not received any lease agreement. In case of triparty agreement the Valuation shall stand Nil.
<br/>
11. We have received a copy of Zoning certificate from Pimpri Chinchwad Municipal Corporation having
No 166/2008 dated 07/05/2008 for Survey No 118 Rahatni being zoned as Part 18 M Road and part
Agricultural. Hence please check for the same. Based on specific instructions received from the Bank we
have released the report.
<br/>
12. The copy of Zoning Certificate received is for Rahatni. The Index II specifies the subject vicinity as
Rahatni Kalewadi. Hence please check for the same and take legal opinion on the same.
<br/>
13. The subject property has an access via kutcha road. Hence in absence of Survey plans / Layout plans we
are unable to comment if the same is Land locked or not.
<br/>
14. The subject property is at a distance of approx 300 m to 400 m from Pawana river. Hence please check
with your guidelines of funding with regards to same.
<br/>
15. Subject property is a part of Gram Panchayat Rahatni as per Market survey. Hence please check with
your guidelines for funding in the same.
<br/>
16. Report is released on available documents as per Banks guidelines.
                        </div>
                      </div>
                      ...
                      <div className="test d-flex">
                        <div className="w-100 text-left p-1 pl-2 test-r">
                          ...
                          Our representative has visited this site. I/We have not verified the title deeds of the properties with the
records of the registrar's office as this is beyond the agreed scope of work.Assumptions are made to the
best of our knowledge and belief. Reliance is based on the information furnished to us by the identifier
AND/OR client.
                          </li>
                          <li>

<br/>
The valuer shall not be responsible for the matters of legal nature that affects the value and opinion
expressed by us.
<br/>
                          </li>
                          <li>

where a sketched plan is attached to this report,it does not purport to represent accurate architectural
plans.Sketch plans and photographs are provided as general illustrations only.Documents furnished to
us are returned to the client along with the report. We cannot preserve them.
<br/>
                          </li>
                          <li>

Fair market value indicated in the report is an opinion of the value prevailing on the date of the said
report and is based on market feedback on values of similar properties. Client is free to obtain other
independent opinions on the same. Fair, market value of such properties / localities may increase or
decrease, depending on the future market conditions & scenarios. value varies with the purpose &
date.This report is not to be referred if the purpose is different other than mentioned.No structural
survey was conducted by us as it is not in our scope of work
<br/>
                          </li>
                          <li>

We hereby declare, “The information furnished above is true and correct to the best of our knowledge
and belief. We have no direct or indirect interest in the assets valued.
                          </li>
</ul>
                    ...
                    <div className="test 4-page text-center pdf-h-w">
                      <div className="test-b w-100">
                        <div className="w-70 mr-auto ml-auto">
                          ...
                          {/* <img className="w-100" src={props.property.property?.} alt="" /> */}
                        </div>
                      </div>
                    ...
                    <div className="page-break"></div>
                    <div className="test 5-page mb-50 text-center pdf-h-w">
                      ...
                      <div className="test-b test-r test-l w-100">
                        ...
                        <div className="w-70 mr-auto ml-auto">
                          <iframe
                            ...
                            scrolling="no"
                          ></iframe>
                          {/* xxxx<iframe src={`https://maps.google.com/maps?q=${props?.property?.property?.latitude},${props?.property?.property?.longitude}&hl=es;&output=embed`} style={{"height": "296px","width": "100%"}}></iframe> */}
                      ...
                      <div className="d-flex flex-wrap">
                        {props.property.property?.photographs
                          ...
                          ?.map((img, i) => {
                            return (
                              <div className="w-50 test-r">
                                <div className="pt-2 mr-auto ml-auto">
                                  {img.file != null ? (
                                    <>
                                      <img
                                        className="w-80"
...
export default connect(mapStateToProps, mapDispatchToProps)(Report122);
