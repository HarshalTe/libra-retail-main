...
const headCells = [
  ...
  {
    id: "flat_postiion_as_per_site",
    numeric: false,
    disablePadding: false,
    label: "Flat Postiion as per site",
  },
  {
    id: "flat_postion_as_pe_plan",
    numeric: false,
    disablePadding: false,
    label: "Flat postion as pe plan",
  },
  {
    id: "no_lifts",
    numeric: false,
...
function AnalogTable(props) {
  ...
  const rows2 = props?.avm?.isLoading
? []
: props.avm.avm?.length > 0
  ? props.avm.avm.filter((pur)=>{
...
const columns2 = [
  ...
  {
    field: "flat_postiion_as_per_site",
    headerName: "Flat Postiion as per site",
    renderCell: (params) => (
      <Tooltip title={params.value}>
        <span>{params.value}</span>
      </Tooltip>
  ...
  {
    field: "flat_postion_as_pe_plan",
    headerName: "Flat postion as pe plan",
    renderCell: (params) => (
      <Tooltip title={params.value}>
        <span>{params.value}</span>
      </Tooltip>
  ...
  {
    field: "carpet_area",
    headerName: "Area range(Carpet area)",
    renderCell: (params) => (
      <Tooltip title={params.value}>
        <span>{params.value}</span>
      </Tooltip>
    ...
    <Box sx={{ width: "100%" }}>
      ...
      <div style={{ height: 650, width: '100%' }}>
        <DataGrid
          rows={rows2}
          columns={columns2}
          loading={props?.avm?.isLoading ? true : false}
          pageSize={10}
...
export default connect(mapStateToProps, mapDispatchToProps)(AnalogTable);
