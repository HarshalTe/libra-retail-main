...
//*Actions
import { editOfflineProperties } from "../../../Redux/Creators/OffilePropertiesCreators";

function EditMisOffline(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.editOfflineProperties(data, token);
    setSubmitting(true);
    setModal(false);
  };
        ...
        <ModalBody>
          <Formik
            initialValues={{
              ...
              final_value: props?.data?.final_value,
                  ...
                  <Col md={6} className="pb-4">
                    {props?.data?.file !== "nofile.pdf" ? (
                      <Button
                        ...
                        color="success"
                        variant="contained"
                        href={`https://lvpl.in/librabackend/storage/app/public/OfflineProperty/${props?.data?.file}`}
                        alt=""
                      >
...
const mapDispatchToProps = (dispatch) => {
  return {
    editOfflineProperties: (data, token) =>
      dispatch(editOfflineProperties(data, token)),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(EditMisOffline);
