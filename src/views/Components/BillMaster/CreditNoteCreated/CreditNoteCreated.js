...
const CreditNoteCreated = (props) => {
  ...
  const columns = [
    ...
    { field: 'party_branch', headerName: 'Party Branch', width: 130
    ,renderCell: (row) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CreditNoteCreated);
