...
//* Actions
import { getBranchPropertiesPage } from "../../../Redux/Creators/PropertiesCreators";
...
function OnGoingBranchCases(props) {
  //*
  ...
  const fetchData = (page, rowsPerPage) => {
    ...
    props.getBranchPropertiesPage(data);
  };
...
const mapDispatchToProps = (dispatch) => {
  return {
    getBranchPropertiesPage: (data) => dispatch(getBranchPropertiesPage(data)),
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(OnGoingBranchCases);
