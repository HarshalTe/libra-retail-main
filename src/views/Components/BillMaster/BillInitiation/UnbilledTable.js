...
const columns2 = [
  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <Table id="table-ReopenBillTable" sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">Postal Address</TableCell>
            <TableCell align="right">Plot Area</TableCell>
            <TableCell align="right">Construction Area</TableCell>
            <TableCell align="right">Property Type</TableCell>
            <TableCell align="right">Verticals</TableCell>
            <TableCell align="right">Product</TableCell>
            <TableCell align="right">Rate</TableCell>
            <TableCell align="right">No. of kms</TableCell>
            <TableCell align="right">Kms from bank</TableCell>
        ...
        <TableBody>
          {rows2.map((row) => (
            ...
            >
              <TableCell component="th" scope="row">{row.application_no}</TableCell>
              <TableCell component="th" scope="row">{row.customer_name}</TableCell>
              <TableCell component="th" scope="row">{row.branch_name}</TableCell>
              <TableCell component="th" scope="row">{row.created_date}</TableCell>
              <TableCell component="th" scope="row">{row.postal_address}</TableCell>
              <TableCell component="th" scope="row">{row.plot_area}</TableCell>
              <TableCell component="th" scope="row">{row.construction_area}</TableCell>
              <TableCell component="th" scope="row">{row.property_type}</TableCell>
              <TableCell component="th" scope="row">{row.verticals}</TableCell>
              <TableCell component="th" scope="row">{row.product}</TableCell>
              <TableCell component="th" scope="row">{row.rate}</TableCell>
              <TableCell component="th" scope="row">{row.kms}</TableCell>
              <TableCell component="th" scope="row">{row.kms_from_bank}</TableCell>
              <TableCell component="th" scope="row">{row.cost}</TableCell>
              <TableCell align="right">{row.final_value}</TableCell>
                </TableRow>
          ))}
        </TableBody>
      </Table>
...
export default connect(mapStateToProps, mapDispatchToProps)(UnBilledTable);
