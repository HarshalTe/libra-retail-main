...
function CancelledBill(props) {
  ...
  const approveAll = (values, { setSubmitting }) => {
    let data = {
      bills: billsIDs,
      // processed_date:values.date,
      is_reopen_closed_processed: 0,
    };
            ...
            {(formProps) => (
              <Form enctype="multipart/form-data">
                <Row>
                  ...
                  Do You want to Cancel Selected?
                  </Col>
                </Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(CancelledBill);
