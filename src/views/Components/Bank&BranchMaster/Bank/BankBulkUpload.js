    ...
    return axios
      ...
      .then((response) => {
        ...
        Swal.fire({
          position: "success",
          icon: "success",
          title: "Successfully Updated The Banks!",
        ...
        <ModalBody>
          ...
          >
            {(formProps) => (
               ...
               <Col md={6}>
               <a href="https://lvpl.in/librabackend/storage/app/public/Demo/Banks.xlsx">
               <Button
          variant="outlined"
          color="info"
          // background="info"
...
export default connect(mapStateToProps, mapDispatchToProps)(BankBulkUpload);
