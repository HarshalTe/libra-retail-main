        ...
        <ModalBody>
          ...
          <Formik
            initialValues={{
              ...
              short_code: props?.data?.short_code,
              format: props?.data?.format,
              agreement_start_date: props?.data?.agreement_start_date,
              agreement_end_date: props?.data?.agreement_end_date,
              age_of_property: props?.data?.age_of_property,
          ...
          >
            {(formProps) => (
              <Form>
                {console.log(formProps.values,"formProps")}
                <Row>
