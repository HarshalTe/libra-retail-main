...
//* Actions
import { branchesPostData } from "../../../../Redux/Creators/BranchesCreators";
...
function AddBranch(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    console.log("Values In Branch Add:", values);
    ...
    console.log("data branch add", data);

    props.branchesPostData(data);
    setSubmitting(true);
    setModal(false);
  };
                          ...
                          <Row>
                            ...
                            <Col md={4}>
                              <TextField
                                ...
                                name="phone_report"
                                label="Phone No."
                                value={formProps.values.phone_report}
                                onChange={formProps.handleChange}
                              >
                              </TextField>
                            </Col>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  arrayHelpers.push({
                                    ...
                                    phone_no: formProps.values.phone_report,
                                    customer_name: formProps.values.name_report,
                                    dob: formProps.values.dob_report,
                                  });
                                  {
                                    formProps.setFieldValue("phone_report", "");
                                    ...
                                    <tr key={index}>
                                      ...
                                      <td>
                                        <TextField
                                          ...
                                          label="Phone No."
                                          variant="outlined"
                                          name={`email_details.${index}.phone_no`}
                                          value={email_details.phone_no}
                                          id="phone_no"
                                        />
                                      </td>
                                      <td>
                          ...
                          <Col md={4}>
                            ...
                            <Col md={4}>
                              <TextField
                                ...
                                name="phone_billing"
                                label="Phone No."
                                value={formProps.values.phone_billing}
                                onChange={formProps.handleChange}
                              >
                              </TextField>
                            </Col>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  arrayHelpers.push({
                                    ...
                                    phone_no: formProps.values.phone_billing,
                                    customer_name: formProps.values.name_billing,
                                    dob: formProps.values.dob_billing,
                                  });

                                  formProps.setFieldValue("phone_billing", "");
...
const mapDispatchToProps = (dispatch) => {
  return {
    branchesPostData: (data) => dispatch(branchesPostData(data)),
