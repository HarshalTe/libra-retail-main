...
//*Actions
import { postExternalData } from "../../../Redux/Creators/ExternalDataCreators";

function AddExternalData(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    console.log("Values In External Data Add:", values);
    ...
    <div>
      ...
      >
        <ModalHeader toggle={() => setModal(!modal)}>
          <Typography>
            <strong>Add External Data</strong>
          </Typography>
        </ModalHeader>
        <Divider />
        <ModalBody>
...
const mapDispatchToProps = (dispatch) => {
  return {
    postExternalData: (data) => dispatch(postExternalData(data)),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(AddExternalData);
